...
// in abstract class access level must be equal or weaker level which is defined in a parent class
//then only it will echoing in child class. otherwise it will not allow to call.
